...
# user 5
User.create!(username: 'Daenerys', password: 'password', email: 'dany@email.com', organization: true, img_url: "http://cdn.images.dailystar.co.uk/dynamic/117/photos/809000/Game-Of-Thrones-season-7-Emilia-Clarke-dragons-Daenerys-Targaryen-1009809.jpg", location: "San Francisco", summary: "I am Daenerys Stormborn of House Targaryen, of the blood of Old Valyria! I am the dragon's daughter, and I swear to you that those who would harm you will die screaming!")

Pet.destroy_all


Pet.create!(name: "Rick", animal_type: "cat", age: 5, img_url: "https://static.pexels.com/photos/358464/pexels-photo-358464.jpeg", location: "San Francisco", user_id: 2, summary: "Weddings are basically funerals with cake. I turned myself into a pickle. I'm Pickle Riiiiick.")
Pet.create!(name: "Morty", animal_type: "cat", age: 1, img_url: "https://vignette.wikia.nocookie.net/animal-jam-clans-1/images/a/a3/324536-cats-brown-kitten.jpg/revision/latest?cb=20161127015136", location: "San Francisco", user_id: 2, summary: "Nobody exists on purpose. Nobody belongs anywhere. We're all going to die.")
Pet.create!(name: "Summer", animal_type: "cat", age: 2, img_url: "https://vignette2.wikia.nocookie.net/animal-jam-clans-1/images/2/22/Cute-Light-Brown-Cat-1920x1200.jpg/revision/latest?cb=20161204235438", location: "San Francisco", user_id: 2, summary: "Boo-ya.")
Pet.create!(name: "Sterling Archer", animal_type: "dog", age: 2, img_url: "https://vetstreet.brightspotcdn.com/dims4/default/3e7dd32/2147483647/crop/0x0%2B0%2B0/resize/645x380/quality/90/?url=https%3A%2F%2Fvetstreet-brightspot.s3.amazonaws.com%2F8d%2Ffa82f0a80611e0a0d50050568d634f%2Ffile%2FSiberian-Husky-2-645mk062811.jpg", location: "San Francisco", user_id: 2, summary: "Phrasing! Something, something, DANGER ZONE! LANA!")
Pet.create!(name: "Lana Kane", animal_type: "dog", age: 1, img_url: "https://i.ytimg.com/vi/oGoPUw0YBAg/maxresdefault.jpg", location: "San Francisco", user_id: 2, summary: "I don’t need a baby to validate my existence.")
Pet.create!(name: "Ghost", animal_type: "dire wolf", age: 7, img_url: "https://i.pinimg.com/originals/0c/92/0d/0c920d58b210a74a75868df885160a5f.jpg", location: "Westeros", user_id: 4, summary: "*growl*")
